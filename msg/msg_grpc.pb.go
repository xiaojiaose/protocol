...
const (
	...
	Msg_SearchAdminBackgroundNotifications_FullMethodName = "/openim.msg.msg/SearchAdminBackgroundNotifications"
...
type MsgClient interface {
	...
	SearchAdminBackgroundNotifications(ctx context.Context, in *SearchAdminBackgroundNotificationsReq, opts ...grpc.CallOption) (*SearchAdminBackgroundNotificationsResp, error)
	// Send message
...
func (c *msgClient) SearchAdminBackgroundNotifications(ctx context.Context, in *SearchAdminBackgroundNotificationsReq, opts ...grpc.CallOption) (*SearchAdminBackgroundNotificationsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchAdminBackgroundNotificationsResp)
	err := c.cc.Invoke(ctx, Msg_SearchAdminBackgroundNotifications_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	SearchAdminBackgroundNotifications(context.Context, *SearchAdminBackgroundNotificationsReq) (*SearchAdminBackgroundNotificationsResp, error)
	// Send message
...
func (UnimplementedMsgServer) SearchAdminBackgroundNotifications(context.Context, *SearchAdminBackgroundNotificationsReq) (*SearchAdminBackgroundNotificationsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchAdminBackgroundNotifications not implemented")
}
...
func _Msg_SearchAdminBackgroundNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchAdminBackgroundNotificationsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SearchAdminBackgroundNotifications(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SearchAdminBackgroundNotifications_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SearchAdminBackgroundNotifications(ctx, req.(*SearchAdminBackgroundNotificationsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchAdminBackgroundNotifications",
			Handler:    _Msg_SearchAdminBackgroundNotifications_Handler,
		},
		{
			MethodName: "SendMsg",
