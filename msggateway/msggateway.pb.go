...
type OnlineBatchPushOneMsgReq struct {
	...
	TargetPlatformIDs []int32                `protobuf:"varint,3,rep,packed,name=targetPlatformIDs,proto3" json:"targetPlatformIDs,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *OnlineBatchPushOneMsgReq) GetTargetPlatformIDs() []int32 {
	if x != nil {
...
const file_msggateway_msggateway_proto_rawDesc = "" +
	...
	"\amsgData\x18\x01 \x01(\v2\x15.openim.sdkws.MsgDataR\amsgData\x12$\n" +
	"\rpushToUserIDs\x18\x02 \x03(\tR\rpushToUserIDs\x12,\n" +
	"\x11targetPlatformIDs\x18\x03 \x03(\x05R\x11targetPlatformIDs\"r\n" +
