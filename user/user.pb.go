...
type GetPaginationUsersReq struct {
	...
	UserStatus    *wrapperspb.Int32Value   `protobuf:"bytes,5,opt,name=userStatus,proto3" json:"userStatus,omitempty"`
...
func (x *GetPaginationUsersReq) GetUserStatus() *wrapperspb.Int32Value {
	if x != nil {
		return x.UserStatus
	}
	return nil
...
func (x *GetPaginationUsersReq) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x06Failed\x18\x03 \x03(\tR\x06Failed\"\xe3\x01\n" +
	...
	"\n" +
	"userStatus\x18\x05 \x01(\v2\x1b.openim.protobuf.Int32ValueR\n" +
	"userStatus\x12\x18\n" +
...
var file_user_user_proto_depIdxs = []int32{
	...
	87, // 11: openim.user.getPaginationUsersReq.userStatus:type_name -> openim.protobuf.Int32Value
	84, // 12: openim.user.getPaginationUsersResp.users:type_name -> openim.sdkws.UserInfo
	84, // 13: openim.user.userRegisterReq.users:type_name -> openim.sdkws.UserInfo
	79, // 14: openim.user.userRegisterCountResp.count:type_name -> openim.user.userRegisterCountResp.CountEntry
	36, // 15: openim.user.subscribeOrCancelUsersStatusResp.statusList:type_name -> openim.user.onlineStatus
	36, // 16: openim.user.getSubscribeUsersStatusResp.statusList:type_name -> openim.user.onlineStatus
	36, // 17: openim.user.getUserStatusResp.statusList:type_name -> openim.user.onlineStatus
	41, // 18: openim.user.setUserOnlineStatusReq.status:type_name -> openim.user.userOnlineStatus
	88, // 19: openim.user.processUserCommandAddReq.value:type_name -> openim.protobuf.StringValue
	88, // 20: openim.user.processUserCommandAddReq.ex:type_name -> openim.protobuf.StringValue
	88, // 21: openim.user.processUserCommandUpdateReq.value:type_name -> openim.protobuf.StringValue
	88, // 22: openim.user.processUserCommandUpdateReq.ex:type_name -> openim.protobuf.StringValue
	51, // 23: openim.user.processUserCommandGetResp.CommandResp:type_name -> openim.user.CommandInfoResp
	54, // 24: openim.user.processUserCommandGetAllResp.CommandResp:type_name -> openim.user.AllCommandInfoResp
	83, // 25: openim.user.searchNotificationAccountReq.pagination:type_name -> openim.sdkws.RequestPagination
	61, // 26: openim.user.searchNotificationAccountResp.notificationAccounts:type_name -> openim.user.notificationAccountInfo
	61, // 27: openim.user.getNotificationAccountResp.account:type_name -> openim.user.notificationAccountInfo
	80, // 28: openim.user.sortQueryReq.userIDName:type_name -> openim.user.sortQueryReq.UserIDNameEntry
	84, // 29: openim.user.sortQueryResp.users:type_name -> openim.sdkws.UserInfo
	36, // 30: openim.user.getAllOnlineUsersResp.StatusList:type_name -> openim.user.onlineStatus
	81, // 31: openim.user.getUserClientConfigResp.configs:type_name -> openim.user.getUserClientConfigResp.ConfigsEntry
	82, // 32: openim.user.setUserClientConfigReq.configs:type_name -> openim.user.setUserClientConfigReq.ConfigsEntry
	83, // 33: openim.user.pageUserClientConfigReq.pagination:type_name -> openim.sdkws.RequestPagination
	77, // 34: openim.user.pageUserClientConfigResp.configs:type_name -> openim.user.clientConfig
